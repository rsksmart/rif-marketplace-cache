...
import { Logger, SupportedServices } from '../../definitions'
...
export default function rnsProcessorFactory (logger: Logger, eth: Eth, services: RnsServices, eventParser?: EventTransformer) {
